  ...
  <div className="container-fluid">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item"><Link className="nav-link" to="/businessen"> Businessen</Link></li>
        <li className="nav-item"><Link className="nav-link" to="/tertainment"> Tertainment</Link></li>
