...
export default class news extends Component {
  articles =  [
    ...
    "author": "Greg Evans",
    "title": "Scientists left have been left shocked adn worrieed by a recent discovery made benneath the Thwaites",
    ...
    {
    "source": {
    "id": "https://cdn.zeebiz.com/hindi/sites/default/files/styles/zeebiz_850x478/public/2022/07/21/93935-whatsapp-image-2022-07-08-at-114320-am.jpeg?itok=JRj4oN_g",
    "name": "CBS Sports"
    },
    "author": "",
...
async componentDidMount(){
  ...
  let url = "https://newsapi.org/v2/top-headlines?country=id&apiKey=f8264201c0a04e829cc23fb70753cd26&page=1";
      ...
      <div className="container my-3">
        ...
        <div className="row my-3" >
          {this.state.articles.map((element) => {
            ...
            <NewsItem title={element.title ? element.title.slice(0,45):""} descc={
              element.title ? element.description.slice(0,90):""} imgUrl={element.urlToImage  } newsUrl={element.url}
             />
          </div>
          })}
        ...
        <button disabled={this.state.page<=1} type="button" class="btn btn-dark mx-3"onClick={this.handlePreviewClick}>&larr; Preview</button>
        <button type="button" class="btn btn-dark"onClick={this.handleNextClick}>next news &rarr;</button>
